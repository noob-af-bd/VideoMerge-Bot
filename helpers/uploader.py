        ...
        if (await db.get_upload_as_doc(cb.from_user.id)) is False:
            ...
            sent_ = await bot.send_video(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [InlineKeyboardButton("Mantainer - BDH", url="https://t.me/bangladeshhoarding")],
                        [InlineKeyboardButton("Support Group", url="https://t.me/bangladeshhoarding"),
                         InlineKeyboardButton("Bots Channel", url="https://t.me/bangladeshhoarding")]
                    ]
                )
            )
        else:
